...
\item \bibentry{mason2012autonomous}
...
\section{(e) Collaborators \& Other Affiliations (CMU unless otherwise noted)}
\noindent \textbf{Co-editors}:
...
Tim Barfoot (UToronto)
Alvaro Collet (Microsoft);
Dieter Fox (UW),
Geoffrey Gordon,
Martial Hebert,
David Hsu (NUS),
...
\noindent \textbf{Graduate Advisors}: Matthew Mason, Michael Erdmann.\\
\noindent \textbf{Thesis Advisor - total 21}:
\textit{PhD} : 
Dmitry Berenson, 
Alvaro Collet, 
Cristopher Dellin,
