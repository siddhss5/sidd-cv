...
\DTLsort{Start=descending,Finish=descending}{students-phd}
\noindent
...
\DTLsort{Start=descending,Finish=descending}{postdocs}
\noindent
...
Thesis: \textit{Following Paths in Task Space: Distance Metrics and Planning Algorithms} \hfill Assistant Professor @ Penn\\
\\
...
Research: \textit{Multi-Step Mobile Manipulation }\hfill CTO @ Agility\\
\\
