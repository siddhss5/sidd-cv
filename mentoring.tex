...
\newif\ifhascurrentms
\hascurrentmsfalse
\DTLforeach*[\DTLiseq{\finish}{}]{students-ms}
{\name=Name,\coadvisor=Coadvisor,\title=Title,\start=Start,\finish=Finish}
{\hascurrentmstrue}
\ifhascurrentms
\subsection{Current M.S. Students}
\noindent
\DTLforeach*[\DTLiseq{\finish}{}]{students-ms}
{\name=Name,\coadvisor=Coadvisor,\title=Title,\start=Start,\finish=Finish}
{\name~\DTLifnullorempty{\coadvisor}{}{(+\coadvisor)} \hfill \start-\\
...
\newif\ifhascurrentpostdocs
\hascurrentpostdocsfalse
\DTLforeach*[\DTLiseq{\finish}{}]{postdocs}
{\name=Name,\coadvisor=Coadvisor,\start=Start,\finish=Finish,\nowat=NowAt}
{\hascurrentpostdocstrue}
\ifhascurrentpostdocs
