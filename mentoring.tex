...
\DTLforeach*[\DTLisieq{\current}{Y}]{students-phd}
{\name=Name,\current=Current,\coadvisor=Coadvisor,\title=Title,\start=Start}
...
\noindent
\DTLforeach*[\DTLisieq{\current}{N}]{students-phd}
{\name=Name,\current=Current,\coadvisor=Coadvisor,\title=Title,\start=Start,\finish=Finish,\nowat=NowAt}
